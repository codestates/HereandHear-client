...
const DummyDatas = [
  {
    ...
    locationTitle: "부산에 사신다면 근처 일본여행은 어떠세요!",
    title: "교토의 철학의 길",
    place: "Kyoto, Japan",
  ...
  },
  {
    ...
    locationTitle: "너무 바쁜 서울러이시라면 하와이로 가볼까요!",
  ...
  },
  {
    ...
    location: "경기",
    month: 4,
    weatherTitle: "으~ 미세먼지ㅠㅠ",
    seasonTitle: "12월에 추천하는 여행지",
    title: "이럴 때는 춥지만 맑은하늘을 가진 러시아 여행 어떠세요",
    place: "Tokyo, Japan",
    text: "덜컹덜컹 - 텍스트 미정",
    recImg: "/img/tokyo_subway.jpg"
  },
