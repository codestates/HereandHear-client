// 날씨변화
// 날씨의 id 값을 weather API의 날씨값으로 획정
const RecWeather = [
  {
    id: 'Rain',
    introTitle: "비가 오는날 추천하는 여행지",
    title: "교토의 철학의 길",
    place: "Kyoto, Japan",
